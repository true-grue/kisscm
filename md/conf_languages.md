...
![Синтаксическая диаграмма грамматики арифметического выражения](https://github.com/true-grue/kisscm/blob/main/images/dsl1.svg){#fig:dsl1}
...
![Упрощенная классификация компьютерных языков](https://github.com/true-grue/kisscm/blob/main/images/dsl2.svg){#fig:dsl2}
