...
На [рисунке 1](#im1) показан пример грамматики арифметического выражения.

<a id="im1"> </a>

![Синтаксическая диаграмма грамматики арифметического выражения](https://github.com/true-grue/kisscm/blob/main/images/dsl1.svg)<p align="right">Рисунок 1</p>
...
Рассмотрим представленную на [рисунке 2](#im2) упрощенную классификацию компьютерных языков.

<a id="im2"> </a>

![Упрощенная классификация компьютерных языков](https://github.com/true-grue/kisscm/blob/main/images/dsl2.svg)<p align="right">Рисунок 2</p>
