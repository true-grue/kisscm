...
![Результат компиляции LaTeX-документа](https://github.com/true-grue/kisscm/blob/main/images/docs1.svg){#fig:docs1}
...
![Полученные формулы](https://github.com/true-grue/kisscm/blob/main/images/docs2.svg){#fig:docs2}
...
![Архитектура Pandoc](https://github.com/true-grue/kisscm/blob/main/images/docs5.svg){#fig:docs5}
...
![Результат работы Graphviz](https://github.com/true-grue/kisscm/blob/main/images/docs6.svg){#fig:docs6}
...
![Результат работы PlantUML](https://github.com/true-grue/kisscm/blob/main/images/docs7.svg){#fig:docs7}
