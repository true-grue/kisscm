...
Результат компиляции документа с помощью `xelatex` показан на [рисунке 1](#im1).

<a id="im1"> </a>

![Результат компиляции LaTeX-документа](https://github.com/true-grue/kisscm/blob/main/images/docs1.svg)<p align="right">Рисунок 1</p>
...
Результат компиляции формул представлен на [рисунке 2](#im2).

<a id="im2"> </a>

![Полученные формулы](https://github.com/true-grue/kisscm/blob/main/images/docs2.svg)<p align="right">Рисунок 2</p>
...
С помощью инструмента `weave` из WEB-файла извлекается только часть, связанная с документацией. С помощью инструмента `tangle` из WEB-файла извлекается программный код. Схема работы WEB показана на [рисунке 3](#im3).


<a id="im3"> </a>

![Схема работы системы WEB](https://github.com/true-grue/kisscm/blob/main/images/docs3.svg)<p align="right">Рисунок 3</p>

На [рисунке 4](#im4) показан пример LaTeX-документа, извлеченного из WEB-файла.

<a id="im4"> </a> 

![Пример WEB-документа](https://github.com/true-grue/kisscm/blob/main/images/docs4.svg)<p align="right">Рисунок 4</p>
...
Архитектура Pandoc показана на [рисунке 5](#im5). Работу Pandoc можно разбить на три этапа:
...
![Архитектура Pandoc](https://github.com/true-grue/kisscm/blob/main/images/docs5.svg)<p align="right">Рисунок 5</p>
...
Результат компиляции в графический файл представлен на [рисунке 6](#im6).


<a id="im6"> </a>

![Результат работы Graphviz](https://github.com/true-grue/kisscm/blob/main/images/docs6.svg)<p align="right">Рисунок 6</p>
...
Результат компиляции в графический файл представлен на [рисунке 7](#im7).

<a id="im7"> </a>

![Результат работы PlantUML](https://github.com/true-grue/kisscm/blob/main/images/docs7.svg)<p align="right">Рисунок 7</p>

## Генераторы документации на основе исходных текстов

Очевидным способом объединения документации и программного кода является подробное комментирование программного кода. При внесении изменений в программу имеет возможность сразу же обновить документирующие поведение программы комментарии в коде. Существуют инструменты, позволяющие автоматически извлечь из файла программы специальным образом оформленные комментарии и оформить результат в виде справочной документации по программному модулю.
