...
На [рисунке 1](#im1) показаны основные виды виртуализации.

<a id="im1"> </a>

![Виды виртуализации](https://github.com/true-grue/kisscm/blob/main/images/vm1.svg)<p align="right">Рисунок 1</p>
...
На [рисунке 2](#im2) представлены основные техники обеспечения виртуализации.

<a id="im2"> </a>

![Техники виртуализации](https://github.com/true-grue/kisscm/blob/main/images/vm2.svg)<p align="right">Рисунок 2</p>
