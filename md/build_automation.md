...
На [Рис. 1](#make1) приведен пример сценария работы с облачной системой сборки. Пользователь совершает следующие действия:
...
<figure>
  <img src="../images/make1.svg" alt="Пример сценария работы с облачной системой сборки" id="make1"/>
  <figcaption>Рис. 1 - Пример сценария работы с облачной системой сборки: 1) загрузка исходных текстов, 2) построение main.exe, 3) модификация util.c и пересборка</figcaption>
</figure>

## Топологическая сортировка

Топологическая сортировка является популярным алгоритмам планировщика в системах сборки.

Рассмотрим пример, показанный на [Рис. 2](#make2). Здесь целевой задачей является «Экипировка», для достижения которого необходимо выполнить подзадачи в корректном порядке. Таким порядком может быть следующий:
...
<figure>
  <img src="../images/make2.svg" alt="Пример графа зависимостей задач" id="make2"/>
  <figcaption>Рис. 2 - Пример графа зависимостей задач</figcaption>
</figure>
...
Рассмотрим пример определения Makefile для графа «экипировки» на [Рис. 2](#make2).
